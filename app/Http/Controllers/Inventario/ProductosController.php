    ...
    public function index()
    {
        try {
            if(Auth::check()){
                ...
                $productos = Productos::with('descripciones','usuario','descripciones.asignaciones.usuario','descripciones.evaluaciones.estatus','descripciones.inventarios','descripciones.perifericos.estatus','descripciones.ubicaciones')->get();
