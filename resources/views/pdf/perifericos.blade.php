@if($subtitle === 'informes' || $subtitle === 'informe')
  ...
  <body>
    ...
    <main class="report-container">
      ...
      <p class="text">A continuación, se detalla la información completa del inventario periféricos con fines de seguimiento y auditoría interna. 
      ...
      @if($perifericos->isEmpty())
        <p>No se encontraron registros de inventario periféricos.</p>
      @else
        <table>
          <thead>
            <tr>
