@if($subtitle === 'informes' || $subtitle === 'informe')
  ...
  <body>
    ...
    <main class="report-container">
      ...
      <p class="text">A continuación, se detalla la información completa del inventario sin periféricos con fines de seguimiento y auditoría interna. 
      ...
      @if($inventarios->isEmpty())
        <p>No se encontraron registros de inventario sin periféricos.</p>
      @else
        <table>
          <thead>
            <tr>
            ...
            @foreach($inventarios as $inventario)
              ...
              <tr class="description-row">
                <td colspan="6" class="description-cell">
                  <strong>Observación:</strong> {{ $inventario->observacion?? '' }}
                </td>
              </tr>
              <tr>
                <td>
                  @if($inventario->descripciones->isNotEmpty())
                    @foreach($inventario->descripciones as $descripcion)
